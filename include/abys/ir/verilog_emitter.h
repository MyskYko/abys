...
namespace abys::ir {
  ...
  private:
    ...
    void emit_expr(const std::string &name, bool nonblocking, const ExprGraph &expr_graph,
                   ExprId root, std::ostream &os) const;
    void emit_expr_rec(const ExprGraph &expr_graph, ExprId id, std::ostream &os) const;
  };
