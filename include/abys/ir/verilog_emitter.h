...
namespace abys::ir {
  ...
  private:
    ...
    void emit_reset_mux_merge(std::string_view lhs, const Module &module, const Module::Node &merge_node, std::string_view rst_name, EdgeKind rst_edge, std::ostream &os, std::string_view indent) const;
